...
set JAVA_ARGS=-mx756 -Dderby.storage.pageReservedSpace=0 -Dderby.language.logQueryPlan=true -Dderby.storage.rowLocking=false -Dfenxi.basedir=%FENXI_HOME% -Djava.awt.headless=true -Dsun.java2d.pmoffscreen=false
